export const T = {
  zh: {
    ...
    installApp: '📲 下載安裝至設備',
    iosPwaTitle: '📲 如何安裝到手機？',
    iosPwaTip: '💡 在 iPhone 上使用：點擊瀏覽器底部的「分享」按鈕 ➔ 選擇「加入主畫面」，即可像 App 一樣使用！',
  ...
  en: {
    ...
    iosPwaTitle: '📲 How to install?',
    iosPwaTip: '💡 To install on iPhone: Tap "Share" at the bottom of Safari ➔ Select "Add to Home Screen" to use it like an App!',
